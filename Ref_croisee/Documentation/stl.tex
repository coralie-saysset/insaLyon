...
\begin{section}{Architecture générale}
  ...
  \begin{subsection}{Diagramme de classe du module CmdLine}
   ...
   \newpage
    ...
    \end{figure}
    \FloatBarrier
    Le module principal permet d'orchestrer les deux modules précédents pour que le programme est le comportement attendu.
   \end{subsection}
...
\begin{section}{Algorithmes principaux}
  ...
  \begin{paragraph}{Description des états :}
   \begin{itemize}
    \item \textbf{Separateur} : Lorsque que l'automate rencontre un séparant deux identifacteur\\Exemple: Tout caractère non alphanumériques, le tiret du bas non inclus
